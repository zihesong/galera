...
def run_monkey(apk, avd_serial, avd_name, output_dir, testing_time, screen_option, login_script, monkey_seed):
    command = 'bash -x run_monkey.sh %s %s %s %s %s %s %s %d' % (apk, avd_serial, avd_name,
                                                              output_dir,
                                                              testing_time,
                                                              screen_option,
                                                              login_script, 
