...
server1="155.98.39.57"
server2="155.98.39.118"
server3="155.98.39.7"
...
sudo add-apt-repository 'deb [arch=amd64] http://nyc2.mirrors.digitalocean.com/mariadb/repo/10.0/ubuntu xenial main'
sudo apt update
